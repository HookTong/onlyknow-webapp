...
@WebServlet(name = "OKGoodsApi", urlPatterns = {"/OKGoodsApi"})
public class OKGoodsApi extends OKBaseApi {
    private final String TAG = "OKGoodsApi";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<GoodsEntity> list = manager.list(username, page, size);
