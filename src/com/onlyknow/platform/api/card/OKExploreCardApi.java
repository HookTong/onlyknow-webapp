...
@WebServlet(name = "OKExploreCardApi", urlPatterns = {"/OKExploreCardApi"})
public class OKExploreCardApi extends OKBaseApi {
    private final String TAG = "OKExploreCardApi";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<CardInfoEntity> list = cardManager.list(false, page, size);
