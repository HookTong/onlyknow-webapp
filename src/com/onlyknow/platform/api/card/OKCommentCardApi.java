...
@WebServlet(name = "OKCommentCardApi", urlPatterns = {"/OKCommentCardApi"})
public class OKCommentCardApi extends OKBaseApi {
    private final String TAG = "OKCommentCardApi";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<OKUserCommentCardBean> list = cardManager.listByComment(username, page, size);
